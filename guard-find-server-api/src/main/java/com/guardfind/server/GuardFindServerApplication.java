...
@EnableFileStorage
@EnableMethodCache(basePackages = "com.guardfind.server")
@EnableFeignClients
@RestController
@SpringBootApplication
@RequiredArgsConstructor
public class GuardFindServerApplication implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication application = new SpringApplication(GuardFindServerApplication.class);
    ...
    public void run(ApplicationArguments args) {
        ...
        log.info("Guard Find Server: 用户侧服务已启动");
        log.info("--------------------------------------------------------");
    }
}