...
package com.guardfind.server.system.model.req;
...
import com.guardfind.server.system.validation.ValidationGroup;
...
public class StorageReq implements Serializable {
     ...
     * Bucket/存储路径
     */
    @Schema(description = "Bucket/存储路径", example = "guard-find-server")
     ...
     * 域名/访问路径
     */
    @Schema(description = "域名/访问路径", example = "https://files.guard-find.local/")
