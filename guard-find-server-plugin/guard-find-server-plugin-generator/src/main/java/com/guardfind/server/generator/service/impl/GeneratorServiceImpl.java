...
package com.guardfind.server.generator.service.impl;
...
import com.guardfind.server.generator.config.properties.GeneratorProperties;
import com.guardfind.server.generator.enums.FormTypeEnum;
import com.guardfind.server.generator.enums.QueryTypeEnum;
import com.guardfind.server.generator.mapper.FieldConfigMapper;
import com.guardfind.server.generator.mapper.GenConfigMapper;
import com.guardfind.server.generator.model.entity.FieldConfigDO;
import com.guardfind.server.generator.model.entity.GenConfigDO;
import com.guardfind.server.generator.model.entity.InnerGenConfigDO;
import com.guardfind.server.generator.model.query.GenConfigQuery;
import com.guardfind.server.generator.model.req.GenConfigReq;
import com.guardfind.server.generator.model.resp.GeneratePreviewResp;
import com.guardfind.server.generator.service.GeneratorService;
...
public class GeneratorServiceImpl implements GeneratorService {
        ...
        try {
            ...
            tableNames.forEach(tableName -> {
                ...
                for (GeneratePreviewResp generatePreview : generatePreviewList) {
                    // 后端：guard-find-server/guard-find-server-system/src/main/java/top/continew/admin/system/service/impl/XxxServiceImpl.java
                    // 前端：guard-find-server/guard-find-server-ui/src/views/system/user/index.vue
                    File file = new File(projectPath + generatePreview.getPath()
                        .replace("guard-find-server\\guard-find-server", ""), generatePreview.getFileName());
                    // 如果已经存在，且不允许覆盖，则跳过
    ...
    private void setPreviewPath(GeneratePreviewResp generatePreview,
        ...
        if (generatePreview.isBackend()) {
            // 例如：guard-find-server/guard-find-server-system/src/main/java/top/continew/admin/system/service/impl
            ...
            // 例如：guard-find-server/guard-find-server-ui/src/views/system
            ...
            // 例如：guard-find-server/guard-find-server-ui/src/views/system/user
    ...
    private String buildBackendBasicPackagePath(GenConfigDO genConfig,
                                                GeneratorProperties.TemplateConfig templateConfig) {
        String extension = templateConfig.getExtension();
        // 例如：guard-find-server/guard-find-server-system/src/main/java/top/continew/admin/system
