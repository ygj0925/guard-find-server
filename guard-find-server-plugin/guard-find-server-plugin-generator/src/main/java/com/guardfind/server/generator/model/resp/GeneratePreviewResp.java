...
package com.guardfind.server.generator.model.resp;
...
public class GeneratePreviewResp implements Serializable {
    ...
    @Schema(description = "生成的文件路径", example = "guard-find-server\\guard-find-server\\guard-find-server-generator\\src\\main\\java\\top\\continew\\admin\\generator\\service")
    private String path;
