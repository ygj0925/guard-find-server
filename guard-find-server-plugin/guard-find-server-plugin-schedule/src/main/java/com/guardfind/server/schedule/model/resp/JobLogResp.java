...
package com.guardfind.server.schedule.model.resp;

import io.swagger.v3.oas.annotations.media.Schema;
import lombok.Data;
import com.guardfind.server.schedule.enums.JobExecuteReasonEnum;
import com.guardfind.server.schedule.enums.JobExecuteStatusEnum;
...
public class JobLogResp implements Serializable {
     ...
     * 任务组
     */
    @Schema(description = "任务组", example = "guard-find-server")
